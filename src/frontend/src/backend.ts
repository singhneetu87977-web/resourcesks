...
export class Backend implements backendInterface {
    ...
    async addItemToCategory(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addItemToCategory(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCategories(): Promise<Array<ResourceCategory>> {
        if (this.processError) {
            try {
    ...
    async getTopCircleScores(arg0: bigint): Promise<Array<CircleScore>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopCircleScores(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitCircleScore(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitCircleScore(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
